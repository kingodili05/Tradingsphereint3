...
export function DashboardModal({ type, onClose, profile, messages }: DashboardModalProps) {
  const { user } = useAuth();
  ...
  const { markAsRead, loading: messagesLoading } = useMessages();
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">Copy Expert Traders</h3>
                <Button 
                  className="bg-green-600 hover:bg-green-700 text-white w-full"
                  onClick={() => {
              ...
              <div className="text-center">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-gray-700 border-gray-600 text-white"
                  />
                  <Button onClick={handleUpdateProfile} className="bg-green-600 hover:bg-green-700 text-white w-full">
                    Update Profile
                  </Button>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="text-left space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className={profile?.is_email_verified ? 'bg-green-500' : 'bg-red-500'}>
                        {profile?.is_email_verified ? 'Yes' : 'No'}
                      </Badge>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 text-sm">Identity Verified:</span>
                      <Badge className={profile?.is_identity_verified ? 'bg-green-500' : 'bg-red-500'}>
                        {profile?.is_identity_verified ? 'Yes' : 'No'}
                      </Badge>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 text-sm">Address Verified:</span>
                      <Badge className={profile?.is_residency_verified ? 'bg-green-500' : 'bg-red-500'}>
                        {profile?.is_residency_verified ? 'Yes' : 'No'}
                      </Badge>
                    </div>
                  </div>
                  <Button 
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">Market Signals</h3>
                <Button 
                  className="bg-green-600 hover:bg-green-700 text-white w-full"
                  onClick={() => {
                    router.push('/education/overview');
                    onClose();
                  }}
                >
                  View Signals
