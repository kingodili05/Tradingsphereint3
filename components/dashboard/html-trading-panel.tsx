...
export default function TradeRealAccountPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'black' }}>
      ...
      {showAlert && (
        <div 
          className="fixed top-16 right-0 z-50 animate-in slide-in-from-right duration-500"
          style={{
            background: '#ffdb9b',
            padding: '15px 40px',
            maxWidth: '420px',
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="flex justify-center space-x-4 pt-6">
                      <Button
                        ...
                        className="bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-6 text-xl flex-1 max-w-[140px] rounded"
                        disabled={!tradeData.exchangeType || !tradeData.symbol || !tradeData.unitWorth || isSubmitting}
                      >
                        <div className="flex flex-col items-center">
                          <div className="mb-2">
                            <svg className="w-8 h-6 text-white" viewBox="0 0 24 16" fill="currentColor">
                      ...
                      <Button
                        ...
                        className="bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-6 text-xl flex-1 max-w-[140px] rounded"
                        disabled={!tradeData.exchangeType || !tradeData.symbol || !tradeData.unitWorth || isSubmitting}
                      >
                        <div className="flex flex-col items-center">
                          <div className="mb-2">
