-- ============================================================
--  TradingSphereIntl — COMPLETE Database Schema (for new project)
--  Consolidated from supabase/FULL_SETUP.sql + all later migrations:
--    - 20260422000000_fix_handle_new_user.sql   (already folded into handle_new_user below)
--    - 20260710000000_sync_email_verified.sql   (new: email-confirm sync trigger)
--    - 20260727120000_bot_trades.sql            (new: bot_trades table)
--
--  Paste this entire file into the Supabase SQL Editor of a FRESH project
--  and run it once. Then run the admin setup line at the bottom.
-- ============================================================
...
-- ============================================================
-- 12. BOT TRADES (admin-initiated auto trades on behalf of a user)
-- ============================================================
...
-- ============================================================
-- 15. HELPER FUNCTIONS (must come before RLS policies)
-- ============================================================
...
-- Sync profiles.is_email_verified with Supabase Auth email confirmation
...
CREATE TRIGGER update_bot_trades_updated_at        BEFORE UPDATE ON public.bot_trades  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

-- ============================================================
-- 17. HANDLE NEW USER TRIGGER
...
-- bot_trades (users read own; admins read all — writes only via service role / API routes)
...
-- ============================================================
-- 20. SAMPLE PRICE DATA (optional — remove if not wanted in new project)
-- ============================================================
...
-- ============================================================
-- DONE!
-- After this runs, sign up with your admin email in the NEW project,
